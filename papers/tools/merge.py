...
import schema, curated_rl, curated_il, curated_sys, curated_recent, curated_ego, curated_multi, curated_mabel, curated_ideas
...
# ------------------------------------------------------------------ curated
CUR = {}
for mod in (curated_rl, curated_il, curated_sys, curated_recent, curated_ego, curated_multi, curated_mabel, curated_ideas):
    for r in mod.ROWS:
        rec = dict(
