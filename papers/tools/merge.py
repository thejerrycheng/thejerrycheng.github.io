...
import schema, curated_rl, curated_il, curated_sys, curated_recent, curated_ego, curated_multi
...
# ------------------------------------------------------------------ curated
CUR = {}
for mod in (curated_rl, curated_il, curated_sys, curated_recent, curated_ego, curated_multi):
    for r in mod.ROWS:
        rec = dict(
